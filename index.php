...
<body>
    ...
    <header id="header">
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-fixed-top nav-span-fold">
       ...
       <ol class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="item active"> 
                    ...
                    <div class="carousel-caption wrapper content-x">
                        <div class="row">
                            <div class="col-md-12 height-up">
                                <div class="intro-text">
                                    <h1 class="intro-lead-in animated bounceInLeft">Creative Digital Agency</h1>
                                    <h2 class="animated bounceInRight hover-bg text-h">adsCamponline</h2>
                                ...
                                <a href="#services" class=" slider-button animated bounceInUp btn-hover color-3" id="text-col">Services</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="carousel-inner team-wrapper">
                    <div class="item active">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8 team-member-bio">
                            <h3 class="team-member-name">Abid Hussain</h3>
    ...
    <section id="contact">
        <div class="container-fluid wrapper">
            <div class="row">
                ...
                <div class="col-md-6">
                                 <div class="company-address col-sm-6 col-md-6">  
                                    ...
                                    Hussaini More<br>
                                    Bindusar Road, Siwan (Bihar)</span>
                                        <br>
                                    </address>
                                </div>
                               <div class="company-contact col-sm-6 col-md-6">
                                    <address>Email Us
                                        <br>
                                        <a href="mailto:#">adscamponline@gmail.com</a>
                                        <br>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form name="form" name="form" method="post" action="form.php">
                        <div class="row">
    ...
    <footer>
        <div class="container-fluid wrapper">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 copyright-bottom">
                <span class="copyright">Copyright &copy; adsCamponline 2021 Developed By <a href="www.adscamponline.com" target="_blank">adsCamponline</a> </span>
            </div>
        </div>
    </footer>
    <!-- Scroll-up -->
